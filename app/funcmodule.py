...
def random_events(person_info):
    ...
    {"event": "YOU ate Top Ramen for the past 3 weeks and you feel sick all the time.", "$amount": -10,
        "health" : -20 , "mental_health": -15, "grades" : 0.0},
    ...
    {"event": "You decided to take a pot brownie from your friend, you fell asleep for 3 days, ate all of your food and missed and eam. Good going dumbass.", "$amount":0,"health" : -50, "mental_health": 10, "grades":-1.0} ]
